...
- The JSON output should contain two fields: **"answer"** and **"summary"**.
  ...
  - In addition to the link, include a brief characteristic or description of each store, such as its specialty or unique feature, based on the SQL result. The description should highlight the store’s most notable aspect, with a focus on key details. Feel free to make it engaging by adding emojis where appropriate to enhance the tone and highlight the store’s unique features. (e.g., "젊은층에게 인기 있는 곳으로, 10대와 20대 고객 비중이 높아요. 👨‍👩‍👧‍👦", "저녁 시간대에 특히 활기찬 분위기가 매력적인 곳이에. 요 🎶")
