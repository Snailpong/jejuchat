...
# Load the data
mct_data = pd.read_csv('data/JEJU_PROCESSED.csv', encoding='cp949')  # Contains MCT_NM, OP_YMD, LATITUDE, LONGITUDE
parking_data = pd.read_csv('data/JEJU_PARKING.csv', encoding='cp949')  # Contains PARKING_NAME, ADDR, LATITUDE, LONGITUDE
